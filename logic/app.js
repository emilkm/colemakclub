...
var keyboardMap = layoutMaps['middlemaknhkj'];
var letterDictionary = levelDictionaries['middlemaknhkj'];
var currentLayout = localStorage.getItem('currentLayout') || 'middlemaknhkj';
